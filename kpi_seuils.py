...
def charger_csv(nom_fichier):
    """Charge un CSV depuis DATA_DIR, renvoie None si le fichier est absent."""
    chemin = f"{DATA_DIR}/{nom_fichier}"
    try:
...
cycles = charger_csv("cycles_production_bloc3_propre.csv")
qualite = charger_csv("cameras_qualite_bloc3_propre.csv")
maintenance = charger_csv("maintenance_machines_bloc3_propre.csv")
pannes = charger_csv("logs_erreurs_machines_bloc3_propre.csv")
airflow = charger_csv("logs_jobs_airflow.csv")
capteurs = charger_csv("capteurs_machines_bloc3_propre.csv")
alertes_infra = charger_csv("alertes_monitoring.csv")
planning = charger_csv("planning_production_bloc3_propre.csv")
usines = charger_csv("usines_bloc3_propre.csv")
